...
|---|-----------|-----------|--------|--------|--------------|---------------|
| 1 | deep-mlp-baseline | **40.52** (±0.63) | 65.11 (±0.60) | 84.35 (±0.61) | 19.58 (±0.68) |  |
| 2 | fast-mlp | **40.26** (±0.74) | 65.34 (±0.67) | 84.38 (±0.68) | 19.13 (±0.95) |  |
| 3 | bottom-top-lstm | **40.07** (±0.80) | 64.42 (±1.47) | 83.37 (±1.52) | 18.14 (±0.61) |  |
| 4 | focal-loss | **39.87** (±1.53) | 63.70 (±2.70) | 82.84 (±2.18) | 17.66 (±2.74) |  |
| 5 | transformer-encoder | **39.75** (±0.94) | 64.67 (±0.31) | 84.62 (±0.49) | 18.90 (±0.57) |  |
| 6 | perceptron-baseline | **39.65** (±0.60) | 65.62 (±0.42) | 84.89 (±0.64) | 20.20 (±0.70) |  |
| 7 | class-balanced-loss | **39.54** (±0.57) | 63.84 (±1.12) | 82.55 (±0.88) | 20.71 (±1.36) |  |
| 8 | gradient-boost-baseline | **39.49** (±0.48) | 62.20 (±0.44) | 80.78 (±0.31) | 15.40 (±0.42) |  |
| 9 | multichannel-2dcnn | **39.44** (±0.78) | 62.61 (±0.98) | 81.44 (±0.74) | 17.60 (±1.20) |  |
...
- **Commit:** `feat/coral-deepmlp-ensemble` (PR #50)
- **Model:** Deep MLP with CORAL ordinal head — 656-dim input → 512 → 256 → 128 → (K-1=11) binary logits. CORAL uses shared weight with cumulative biases for monotonic threshold prediction. **Key innovation: bias initialization from empirical grade distribution** (`bias[k] = logit(P(grade > k))`) to prevent model collapse to single-grade predictions.
- **Loss Function:** FocalBCELoss(gamma=2.0) over ordinal thresholds (11 binary outputs per sample)
...
- **Key Observations:**
  - Combines the best features (deep-mlp's 656-dim) with the best loss (CORAL ordinal regression)
