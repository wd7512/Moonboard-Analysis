...
def load_model_and_vocab(
    ...
    # Note: weights_only=False is intentional as checkpoint contains custom model state
    # and config that cannot be serialized with regular types. The checkpoint source
    # is trusted (generated by the training script in this same project).
